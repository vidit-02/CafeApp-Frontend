...
export class ManageOrderComponent implements OnInit {
  ...
  getCategory(){
    this.categoryService.getFilteredCategories().subscribe((res)=>{
  ...
  getProductDetails(value:any){
    this.productService.getById(value.id).subscribe((res:any)=>{
      ...
      this.manageOrderForm.controls['total'].setValue(res.price);
    },(err)=>{
      this.ngxService.stop();
      console.log(err);
      if(err.error?.message){
  ...
  add(){
    ...
    if(productName === undefined){
      ...
      this.dataSource.push({id:formData.product.id, name: formData.product.name, category: formData.product.category, quantity: formData.product.quantity, price: formData.product.price, total: formData.product.total});
